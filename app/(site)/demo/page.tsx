      ...
      <div className="mt-10 flex h-[min(60vh,480px)] flex-col rounded-2xl border border-white/10 bg-[#0c1222]">
        ...
        <div className="border-t border-white/10 p-3">
          <div className="flex gap-2">
            <input
              className="flex-1 rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white placeholder:text-slate-500 focus-visible:border-cyan-500/50 focus-visible:outline-none"
